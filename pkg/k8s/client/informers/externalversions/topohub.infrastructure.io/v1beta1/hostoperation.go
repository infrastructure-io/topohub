...
type HostOperationInformer interface {
	...
	Lister() topohubinfrastructureiov1beta1.HostOperationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TopohubV1beta1().HostOperations().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TopohubV1beta1().HostOperations().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TopohubV1beta1().HostOperations().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TopohubV1beta1().HostOperations().Watch(ctx, options)
			},
		},
		&apistopohubinfrastructureiov1beta1.HostOperation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hostOperationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apistopohubinfrastructureiov1beta1.HostOperation{}, f.defaultInformer)
}

func (f *hostOperationInformer) Lister() topohubinfrastructureiov1beta1.HostOperationLister {
	return topohubinfrastructureiov1beta1.NewHostOperationLister(f.Informer().GetIndexer())
}
